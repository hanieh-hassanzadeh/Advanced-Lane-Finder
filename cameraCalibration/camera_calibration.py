...
if __name__ == '__main__':
    ...
    pickleFile = '../src/camera_calibration_parameters.pickle'
    with open(pickleFile, 'wb') as handle:
        pickle.dump(camCalParam, handle, protocol=pickle.HIGHEST_PROTOCOL)
    
    print("Camera calibration parameters (mtx and dist) were written into the %s file."%pickleFile)

    ################################################
    #plotting an example of an original and an undistorted image, 
    #using computed the camera matrix and distortion coefficients.
    ...
    print("\n Compare an example of an original and an undistorted image, using computed")
    print("the camera matrix and distortion coefficients, plotted into ../outputImages/undistortion.jpg")
